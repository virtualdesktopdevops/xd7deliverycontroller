...
class xd7mastercontroller::siteconfig inherits xd7mastercontroller {
  ...
  if ($xd7mastercontroller::role == 'primary') {
    #Databases creation
    ...
    dsc_xd7waitforsite{ 'WaitForXD7Site':
      dsc_sitename               => $xd7mastercontroller::sitename,
      dsc_existingcontrollername => $xd7mastercontroller::site_mastercontroller,
      dsc_credential             => {
        'user'     => $xd7mastercontroller::setup_svc_username,
        'password' => $xd7mastercontroller::setup_svc_password
      }
  ...
  ->dsc_xd7controller{ 'XD7ControllerJoin':
      dsc_sitename               => $xd7mastercontroller::sitename,
      dsc_existingcontrollername => $xd7mastercontroller::site_primarycontroller,
      dsc_credential             => {
        'user'     => $xd7mastercontroller::setup_svc_username,
        'password' => $xd7mastercontroller::setup_svc_password
      }
